...
export  function createInvoice(invoice, path) {
 ...
 function generateHeader(doc) {
  doc
    ...
    .fillColor("#09c")
    .fontSize(20)
    .text("E_COM_ORDER", 110, 57)
    .fontSize(10)
    .text("E_COM_ORDER", 200, 50, { align: "right" })
    .text("Cairo,Maddi", 200, 65, { align: "right" })
...
function generateCustomerInformation(doc, invoice) {
  ...
  doc
    ...
    .font("Helvetica-Bold")
    .text(invoice.shipping.email, 150, customerInformationTop)
    .font("Helvetica")
...
function generateTableRow(
  ...
  doc
    ...
    .text(unitePrice, 280, y, { width: 90, align: "right" })
    .text(quntitiy, 370, y, { width: 90, align: "right" })
